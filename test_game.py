...
def assert_method_number(result, solved, strikes, balls):
...
def test_return_solved_result_if_matched_number(game):
    game.question = "123"
    assert_method_number(game.guess("123"), solved=True, strikes=3, balls=0)


def test_return_solved_result_if_unmatched_number(game):
    game.question = "123"
    assert_method_number(game.guess("456"), solved=False, strikes=0, balls=0)
